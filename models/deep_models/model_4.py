...
class Autoencoder_Deep_4(nn.Module):
    def __init__(self):
        super(Autoencoder_Deep_4, self).__init__()
    ...
    def forward(self, x):
        ...
        encoder = self.encoder_relu_9(self.encoder_conv_9(x))
        ...
        add = torch.add(d8, e2)
        decoder = self.decoder_relu_9(self.decoder_conv_9(add))
